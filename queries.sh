...
echo "$($PSQL "SELECT DISTINCT(name) FROM games FULL JOIN teams ON (teams.team_id=games.winner_id OR teams.team_id=games.opponent_id) WHERE (year=2014 AND round='Eighth-Final');")"
